...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument('key', type=str, help='Encryption key (must be at least 16 characters long)')
        parser.add_argument('--force', action='store_true', help='Overwrite .env file if it already exists')
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS('Environment variables decrypted and saved to .env'))