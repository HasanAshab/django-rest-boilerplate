...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument('--key', type=str, default=self.generate_key(), help='Encryption key')
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS('Environment variables encrypted successfully.'))
