...
from api.users.policies import (
    UserPolicy,
)
...
class UserPolicyTestCase(TestCase):
    ...
    def test_user_can_not_be_staff(
        self,
    ):
    ...
    def test_user_can_not_be_admin(
        self,
    ):
        self.client.force_authenticate(user=self.user)
    ...
    def test_user_can_not_make_staff(
        self,
    ):
        user2 = UserFactory()
        url = reverse(
    ...
    def test_user_can_not_make_admin(
        self,
    ):
        user2 = UserFactory()
        url = reverse(
    ...
    def test_staff_can_not_make_staff(
        self,
    ):
        user2 = UserFactory()
        url = reverse(
    ...
    def test_staff_can_not_make_staff_to_user(
        self,
    ):
        user2 = UserFactory()
        url = reverse(
    ...
    def test_staff_can_not_make_admin(
        self,
    ):
        user2 = UserFactory()
        url = reverse(
